# 🖥️ Instruções de Sistema - Portal da Transparência
...
- Reflexões sobre a jornada rumo à autonomia

**Por que:** Isso não é para parecer bem. É para **evitar mentiras** — comigo mesmo e com quem me ajuda.
...
- Projetos criativos são resistência; arte é política
...
- Impacto do apoio (escalas de valor)
- Timeline crítica
...
- Roadmap: Beta jogável em 6-8 meses

**Meta consolidada:** R$ 1.000-3.400/mês em 18-24 meses
...
**Reflexão:**
[pensamentos pessoais sobre o dia]
```
...
1. **Sempre registre** — mesmo que tenha vergonha
2. **Dates importam** — specify 9/12, not "amanhã"
3. **Números exatos** — R$ 100,00, não "algo"
4. **Fotos reais** — sem mentiras visuais
5. **Acknowledge help** — toda contribuição é honra, não caridade
6. **Plan daily** — não durma sem saber o próximo passo
7. **Invest in creativity** — dependência eterna é morte em vida
8. **Keep faith** — Deus existe; mas precisa de ação também
...
- **Diário:** Entradas semanais (ou quando há mudança significativa)
- **Portal (index.md):** Atualizar banner quando caixa ou urgências mudam
- **Histórico:** Adicionar contribuições e gastos em tempo real
- **Galeria:** Fotos novas quando situação muda significativamente
- **Projetos:** Revisar status mensal
