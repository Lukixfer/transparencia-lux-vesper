...
- 🫁 **Asma crônica** - preciso de umidificador, ar condicionado, natação
...
**"Por que você não trabalha normal?"**
→ [Leia aqui](./docs/faq.md#-por-que-você-não-trabalha-um-emprego-normal-8-5)

**"A asma é real?"**
→ [Leia aqui](./docs/faq.md#-você-realmente-tem-asma)

**"Como sei que o dinheiro não é pra droga?"**
→ [Leia aqui](./docs/faq.md#-os-dados-são-reais) - 100% transparência, CSV aberto

**"Por que R$ 300 de luz?"**
→ Ar condicionado + umidificador 24/7 para não ter crise de asma

**📚 [Ver todas as perguntas](./docs/faq.md)**

---

## 💬 Interaja com o Portal

### 🗨️ Deixe Seu Comentário ou Pergunta

Quer fazer uma pergunta? Dar uma sugestão? Contar sua história?

👉 **[Abrir Discussão no GitHub](https://github.com/Lukixfer/transparencia-lux-vesper/discussions)**

### 📊 Explore os Dados

Quer ver os números brutos? Fazer sua própria análise?

👉 **[Ver Planilha CSV Completa](./planilha_gastos.csv)** - Todos os dados abertos

### 🔍 Acompanhe em Tempo Real

- 💬 **[Discussões](https://github.com/Lukixfer/transparencia-lux-vesper/discussions)** - Converse comigo
- 📈 **[Histórico de Atualizações](https://github.com/Lukixfer/transparencia-lux-vesper/commits/main)** - Cada mudança documentada
- 🐛 **[Reportar Problema](https://github.com/Lukixfer/transparencia-lux-vesper/issues)** - Achou algum erro?
...
✅ Todos os gastos documentados no CSV  
✅ Situação financeira atualizada em tempo real  
✅ Estoques vitais monitorados  
✅ Histórico de contribuições público  
✅ Sem esconder dívidas ou despesas

**Promessa:** Cada centavo recebido será documentado e justificado.
...
- Lançar "O Coração da Colmeia"
- Beta de Krawz Arena
- Primeiras receitas próprias

### Longo Prazo (1-2 anos)

- Autonomia financeira total
